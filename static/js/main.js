...
function maxDialog() {
    ...
    el_dialog.style.top = 60 + "px";
    el_dialog.style.width = window.innerWidth - 5 + "px";
    el_dialog.style.maxHeight = window.innerHeight - (60+35) + "px";
    el_dialog.style.height = window.innerHeight - (60+35) + "px";
    $(this).blur();
...
function showDialog() {
    el_dialog = $("#dialog")[0];
    el_dialog.style.display = "inline-grid"
    el_dialog.style.maxHeight = 450 + "px";
    el_dialog.style.height = 500 + "px";
    $("#dialog").show();
}
// 隐藏弹窗
function hideDialog() {
